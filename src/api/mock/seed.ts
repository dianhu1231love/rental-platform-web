...
export const seedMenus: Menu[] = [
  ...
  },
  {
    ...
    component: 'market/opportunity/index',
    title: '商机管理',
    i18nKey: 'menu.opportunity',
    icon: 'Tickets',
    sort: 1,
    visible: true,
    autoRefresh: false,
    perms: 'market:opportunity:list',
    buttons: [
      { label: '新增', perm: 'market:opportunity:add' },
      { label: '编辑', perm: 'market:opportunity:edit' },
      { label: '删除', perm: 'market:opportunity:delete' },
      { label: '查看', perm: 'market:opportunity:view' },
    ],
  },
]
...
export const seedOpportunities: Opportunity[] = [
  {
    ...
    contact: '张伟',
    phone: '13800000001',
    region: ['31', '3101', '310115'],
    addressDetail: '世纪大道 100 号',
    address: '上海市市辖区浦东新区世纪大道 100 号',
    status: 'following',
    stage: 20,
    leaseTerm: '12个月',
    leaseMode: 'month',
    estimatedIncome: 120000,
    estimatedContract: 120000,
    remark: '首批洽谈高空作业平台租赁',
    details: [
      {
        id: 1,
  ...
  },
  {
    ...
    contact: '李娜',
    phone: '13900000002',
    region: ['33', '3301', '330108'],
    addressDetail: '滨江区江南大道 588 号',
    address: '浙江省杭州市滨江区滨江区江南大道 588 号',
    status: 'won',
    stage: 100,
    leaseTerm: '3年',
    leaseMode: 'year',
    estimatedIncome: 330000,
    estimatedContract: 330000,
    remark: '叉车年度框架协议',
    details: [
      {
        id: 1,
